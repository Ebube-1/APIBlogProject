package com.example.forgotpassword.integrationtests;
...
class UserManagementControllerTest {
    ...
    void whenResetPasswordWithValidToken_ShouldSucceed() throws Exception {
        ...
        boolean passwordMatches = passwordEncoder.matches(newPassword, updatedUser.getPasswordHash());
    ...
    private User createUser() {
        User user = User.builder()
                ...
                .passwordHash(faker.lorem().characters(30))
                .build();
